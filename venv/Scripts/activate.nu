...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Batuhan\PycharmProjects\SLP_EXERCİSE\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Batuhan\PycharmProjects\SLP_EXERCİSE\venv\Scripts\deactivate.nu'
